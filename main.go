...
func main() {
	...
	mux.HandleFunc("/droplets/{dropletID}/actions/{actionID}", GetDropletActionByActionIDHandler).Methods("POST")
	...
	mux.HandleFunc("/droplets/{dropletID}/resources/selective", DeleteDropletWithResourcesSelectivelyHandler).Methods("POST")
